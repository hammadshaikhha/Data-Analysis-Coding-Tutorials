...
ivregress 2sls lwage educ exper expersq (hours = age kidslt6 nwifeinc)

* IV labour supply regression with endogenous education
ivregress 2sls hours age kidslt6 nwifeinc (lwage educ = exper expersq motheduc fatheduc)
